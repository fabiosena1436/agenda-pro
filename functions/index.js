...
// Função onUserCreate (sem alterações)
...
// Função calculateAvailableSlots (corrigida anteriormente, sem novas alterações)
...
/**
 * DOCUMENTAÇÃO: createSubscription
 * MUDANÇA: Aplicamos a mesma correção do CORS a esta função.
 * Agora, ela também é do tipo `onRequest` e é envolvida pelo `cors`.
 */
